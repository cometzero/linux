...
#define APOLLO_HEXAGON_APKO_PAYLOAD_MAGIC 0x5041594c
#define APOLLO_HEXAGON_APKO_PAYLOAD_VERSION 0
#define APOLLO_HEXAGON_APKO_PAYLOAD_DESCRIPTOR_WORDS 4
#define APOLLO_HEXAGON_APKO_CODE_MAGIC 0x45444f43
#define APOLLO_HEXAGON_APKO_CODE_VERSION 0
#define APOLLO_HEXAGON_APKO_CODE_DESCRIPTOR_WORDS 4
#define APOLLO_HEXAGON_APKO_CODE_PROGRAM_WORDS 2
#define APOLLO_HEXAGON_APKO_CODE_OP_MODEL_DISPATCH 0x00010000u
#define APOLLO_HEXAGON_APKO_CODE_OP_END 0x00020000u
#define APOLLO_HEXAGON_APKO_CODE_OP_MASK 0xffff0000u
#define APOLLO_HEXAGON_APKO_CODE_MODEL_MASK 0x0000ffffu
...
#define APOLLO_HEXAGON_CMDQ_SUBMIT_MAX_PACKETS 4
...
#define APOLLO_HEXAGON_CMDQ_OPCODE_LOAD_PAYLOAD 6
#define APOLLO_HEXAGON_CMDQ_OPCODE_LOAD_CODE 7
